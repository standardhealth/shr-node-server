 ...
 * 2. In each function, replace the autogenerated `res.end()` line with the appropriate function from this file to execute the desired outcome, passing in
 * all parameters. See each function for the appropriate line to add.
 */


// In DefaultService.js in getPatientById(), replace res.end() with: patientHandler.getPatientById(args, res, next);
